...
function add_master_scripts() {
    ...
    wp_enqueue_script( 'awesome', 'https://use.fontawesome.com/ea11f7796f.js', false, '4.7.0', false );
    ...
    wp_enqueue_script('custom_script', get_template_directory_uri() . '/js/script.js', array( 'jquery' ), '0.1', true );
    wp_enqueue_script('bootstrap-script', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '0.1', true );

}
add_action('wp_enqueue_scripts','add_master_scripts');
